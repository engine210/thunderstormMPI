...
run("Export results", "floatprecision=1 filepath=" + parts[1] + ".csv" + " fileformat=[CSV (comma separated)] sigma=true intensity=true offset=true saveprotocol=false x=true y=true bkgstd=true id=false uncertainty_xy=true frame=true");
